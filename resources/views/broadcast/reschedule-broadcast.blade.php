...
<!-- Right Content -->
 <div class="content">
      <div class="heading clearfix">
        ...
        <li class="active">Re-Schedule Broadcast </li>
      </ul>
      </div>
      <div class="row">
		<div class="col-lg-12 col-md-12">
            ...
            <header class="panel_header marginBottom">
                <h2 class="title pull-left">Re-Schedule Broadcast</h2>
                <div class="actions panel_actions pull-right">
                	<a href="{{ route('broadcast.view-broadcast') }}" class="btn btn-md btn-primary"><i class="fa fa-eye"></i>&nbsp;View Broadcast</a>
                </div>
            </header>
            <div class="content-body"> 
			<div class="row createbtnbg ">
				<div class="col-xs-12">
				<label for="division">Re-Schedule&nbsp;&nbsp;</label> 
					<label class="cradio">SMS Broadcast
						<input type="radio" checked="checked" name="broadcast" value="smsbroadcast" >
				...
				<form class="form-horizontal inlineform marginbottom10">
					...
					<div class="form-group row">
							...
							<div class="col-md-8">
								...
								<input type="radio" checked="checked" disabled name="broadcastcat" value="simple" >
								<span class="checkmark"></span>
							</label>
							<label class="cradio">One-to-One
									  <input type="radio" value="oneone" disabled name="broadcastcat">
									  <span class="checkmark"></span>
							</label>
							<label class="cradio">Dynamic
									  <input type="radio" value="dynamic" disabled name="broadcastcat">
									  <span class="checkmark"></span>
							</label>
							<label class="cradio">Reminder
									  <input type="radio" value="reminder" disabled name="broadcastcat">
									  <span class="checkmark"></span>
							</label>
					         </div>
			</div>
			...
			<div class="form-group row">
							...
							<div class="col-md-8">
								...
								<input type="radio" checked="checked" disabled name="mgcat" value="alert" >
								<span class="checkmark"></span>
							</label>
							<label class="cradio">Promotional
									  <input type="radio" value="promo" disabled name="mgcat">
									  <span class="checkmark"></span>
							</label>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<label class="cradio">National
								<input type="radio" checked="checked" disabled name="btermination" value="national" >
								<span class="checkmark"></span>
							</label>
							<label class="cradio">International
									  <input type="radio" value="international" disabled name="btermination">
									  <span class="checkmark"></span>
							</label>
							<label class="cradio">All
									  <input type="radio" value="ctall" disabled onclick="new PNotify({
		...
		<div class="tab-content">
			...
			<fieldset>
				...
				<div class="col-md-8">
						<label class="cradio">Simple Message
								<input type="radio" checked="checked" disabled name="msgtype" value="simple" >
								<span class="checkmark"></span>
							</label>
							<label class="cradio">Flash Message
									  <input type="radio" value="flash" disabled name="msgtype">
									  <span class="checkmark"></span>
							</label>
			...
			<div class="simplebox"><!-- simple broadcast category start -->
				...
				<div class="col-md-8">
						<label class="cradio">Manual
								<input type="radio" checked="checked" disabled name="msgcontent" value="mannual" >
								<span class="checkmark"></span>
							</label>
							<label class="cradio">Template
									  <input type="radio" value="template" disabled name="msgcontent">
									  <span class="checkmark"></span>
							</label>
			...
			<div class="form-group row">
				...
				<div class="col-md-8">
						<textarea disabled>Dear customer Big billion day is back, Please click below link to expore and make your wishlist. http://acl.cc/bigbillion </textarea>
			...
			<div class="form-group row">
				...
				<div class="col-md-8">
						<label class="ccheck">Allow Unicode
								<input type="checkbox" disabled id="allowuni" value="Allow Unicode" name="allowuni" data-toggle="tooltip" data-placement="top" data-original-title="Check to allow vernacular messaging. You can copy and paste the vernacular text in the message box.">
								<span class="ccheckmark"></span>
							</label>
				...
				<div class="col-md-8"><select class="minhght" name="DELIMETED">
					...
					<div class="col-md-8">
						<label class="ccheck" data-toggle="tooltip" data-placement="top" data-original-title="" > Scrub Blacklist Numbers
							<input type="checkbox" id="blacklistnumber" disabled value="blacklistnumber" name="blacklistnumber" >
								<span class="ccheckmark"></span>
						</label>
			...
			<div class="form-group row">
				...
				<label for="templatename" class="col-md-4">Message :</label>
				<div class="col-md-8">
						<textarea disabled>Dear #customer Stmt for HDFCBANK Creditcard ending #CCNO dispatched. Min due Rs #MINDUE. Total Due #TDUE. Pymt due on #DATE.</textarea>
						<i data-toggle="tooltip" data-placement="top" data-original-title="Upto 160 ASCII text characters are supported in a single SMS but in a long message the length supported is ASCII message limit specified in the generic section> characters. These special characters |, ^, {, }, €, [, ~, ] and \ will be treated as two characters. 
						Please select the Unicode option if any Unicode characters are present in the file. If not selected Unicode characters in the file will be 
						rendered as ?." class="fa fa-question-circle"></i>
						<p>0/612</p>
					...
					<div class="form-group row">
				<label for="templatename" class="col-md-4">Select Delimeter :</label>
				<div class="col-md-8"><select class="minhght" name="DELIMETED" disabled>
                                     <option selected="selected" value="">--Select Delimeter--</option>
                                      <option value="1">Tilde ~</option>
                                      <option value="2">Tab </option>
                                      <option value="3">Pipe |</option>
			...
			<div class="form-group row">
							...
							<div class="col-md-8">
								<label class="cradio">Manual
								<input type="radio" checked  disabled name="reciept" value="rmanual" >
								<span class="checkmark"></span>
							</label>
							<label class="cradio">File Upload
									  <input type="radio" disabled value="rupload" name="reciept">
									  <span class="checkmark"></span>
							</label>
							<label class="cradio">Group Selection
									  <input type="radio" disabled value="rselection" name="reciept">
									  <span class="checkmark"></span>
							</label>
							</div>
				</div>
				<div class="rmanual">
					...
					<div class="col-md-8">
						<label class="ccheck" data-toggle="tooltip" data-placement="top" data-original-title="" > Scrub Blacklist Numbers
							<input type="checkbox" disabled id="blacklistnumber" value="blacklistnumber" name="blacklistnumber" >
								<span class="ccheckmark"></span>
						</label>
					...
					<div class="col-md-8">
						<label class="ccheck" data-toggle="tooltip" data-placement="top" data-original-title="Rejects duplicate numbers to prevent duplicate messaging. Duplicate numbers should be exact match. Number with country code is different from number without country code. Requires additional processing time while the campaign is in Processing status." >Reject duplicate numbers.
							<input type="checkbox" id="duplicate" disabled value="duplicate" name="duplicate" >
								<span class="ccheckmark"></span>
						</label>
