...
<!-- Right Content -->
    <div class="content">
       <div class="heading clearfix">
		...
		<small>Campaign Summary</small></h2>
        ...
        <li class="active">Campaign Summary Report</li>
      </ul>
      </div>
	  ...
	  <div class="row">
		...
		<section class="box ">
            <header class="panel_header">
                <h2 class="title pull-left">Broadcast Summary</h2>
                <div class="actions panel_actions pull-right">
			...
			<table id="example1" class="table table-striped display dt-responsive table-bordered dataTable" width="100%">
			   ...
			   <tbody>
				   <tr>
					...
					<td>50</td>
					<td>400</td>
					<td><a href="{{ route('broadcast.failed-reason') }}" class="viewlink" data-toggle="tooltip" data-placement="top" data-original-title="Click to View Failed Reason">50</td>
				 </tr>
				 <tr>
