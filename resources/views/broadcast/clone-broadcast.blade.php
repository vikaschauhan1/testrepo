...
<!-- Right Content -->
 <div class="content">
      <div class="heading clearfix">
        ...
        <li class="active">Copy Broadcast </li>
      </ul>
      </div>
      <div class="row">
		<div class="col-lg-12 col-md-12">
            ...
            <header class="panel_header marginBottom">
                <h2 class="title pull-left">Copy Broadcast</h2>
			...
			<div class="row createbtnbg ">
				...
				<form class="form-horizontal inlineform marginbottom10">
					...
					<div class="form-group row">
							...
							<a href="#." class="btn btn-primary-outline btn-xs">Check Availability</a><br>
			...
			<fieldset>
				...
				<div class="col-md-8">
						<label class="cradio">Simple Message
								<input type="radio" checked="checked" name="msgtype" value="simple" >
								<span class="checkmark"></span>
							</label>
							<label class="cradio">Flash Message
									  <input type="radio" value="flash" name="msgtype">
									  <span class="checkmark"></span>
							</label>
