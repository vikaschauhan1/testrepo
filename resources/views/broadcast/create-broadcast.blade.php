      ...
      <div class="row">
            ...
            <div class="content-body"> 
				...
				<form class="form-horizontal inlineform marginbottom10">
					...
					<div class="form-group row">
							...
							<div class="col-md-8">
							<input type="text" id="broadcatname" value="CreditCard" />
							<a href="#." class="btn btn-primary-outline btn-xs" id="check_availibilty">Check Availability</a><br>
                            <br><span id="success" class="label hide label-success marginTop5"></span>
                            <!-- <p class="label label-success marginTop5">Broadcast name available</p> -->
							</div>
					</div>
					<div class="form-group restbox row">
						<label for="broadcastschd" class="col-md-4">Broadcast Schedule:</label>
						<div class="col-md-8">
						<input type="text" class="datetime1" id="fromdate" value="" />
					...
					<div class="form-group reminderbox row">
						...
						<div class="col-md-8">
						<input type="text" class="datetime" id="startdate" value="" />
					...
					<div class="form-group row">
							...
							<div class="col-md-8">
								...
								<input type="radio" checked="checked" name="broadcastcat" value="simple" >
								<span class="checkmark"></span>
							</label>
							<label class="cradio">One-to-One
									  <input type="radio" value="oneone" name="broadcastcat">
									  <span class="checkmark"></span>
							</label>
							<label class="cradio">Dynamic
									  <input type="radio" value="dynamic" name="broadcastcat">
									  <span class="checkmark"></span>
							</label>
							<label class="cradio">Reminder
									  <input type="radio" value="reminder" name="broadcastcat">
									  <span class="checkmark"></span>
							</label>
					         </div>
					</div>
					...
					<div class="form-group row">
							...
							<label class="cradio">National
								<input type="radio" checked="checked" name="btermination" value="national" >
								<span class="checkmark"></span>
							</label>
							<label class="cradio">International
									  <input type="radio" value="international" name="btermination">
									  <span class="checkmark"></span>
							</label>
							<label class="cradio">All
									  <input type="radio" value="ctall" name="btermination">
									  <span class="checkmark"></span>
							</label>
		...
		<div class="tab-content">
			...
			<div class="simplebox"><!-- simple broadcast category start -->
				...
				<div class="col-md-8">
						<select id="selecttemp">
							...
							<option value="hdfcpromo">Hdfc promotion</option>
			...
			<div class="form-group row">
				...
				<div class="col-md-8">
						<textarea onkeyup="countChar(this)" id="simpletextarea">Dear customer Big billion day is back, Please click below link to explore and create your wishlist. http://acl.cc/bigbillion </textarea>
						...
						<p>Left char: <b><span class="broadcastmsg">488</span></b> /612 &nbsp;&nbsp;<span>Message Count:<b class="msgcounts">1</b></span></p>
			...
			<div class="form-group row">
				...
				<label for="templatename" class="col-md-4">Message :</label>
				<div class="col-md-8">
						<textarea disabled>Dear {1} Stmt for HDFCBANK Creditcard ending {2} dispatched. Min due Rs {3}. Total Due {4}. Pymt due on {5}.</textarea>
						<i data-toggle="tooltip" data-placement="top" data-original-title="Upto 160 ASCII text characters are supported in a single SMS but in a long message the length supported is ASCII message limit specified in the generic section> characters. These special characters |, ^, {, }, €, [, ~, ] and \ will be treated as two characters. 
						Please select the Unicode option if any Unicode characters are present in the file. If not selected Unicode characters in the file will be 
						rendered as ?." class="fa fa-question-circle"></i>
						<p>0/612</p>
			...
			<footer>
				<div class="form-group row text-center">
							...
							<div class="col-md-12">
								<a href="{{ route('broadcast.broadcast-preview') }}" class="btn btn-primary"><i class="fa fa-floppy-o"></i>&nbsp;Preview</a>
